...
";
    ...
    match Parser::read_indented_block(&lines, 2, false, Some(true), None, None, false) {
...
";
    ...
    match Parser::read_indented_block(&lines, 2, false, None, Some(2), None, false) {
        Ok((lines, _indent, line_diff, _empty_finish)) => {
            eprintln!("{:#?}", lines);
...
";
    ...
    match Parser::read_indented_block(&lines, 2, false, None, None, None, false) {
        Ok((lines, _indent, line_diff, _empty_finish)) => {
            eprintln!("{:#?}", lines);
...
";
    ...
    match Parser::read_indented_block(&lines, 2, false, None, Some(2), Some(2), false) {
        Ok((lines, _indent, line_diff, _empty_finish)) => {
            eprintln!("{:#?}", lines);
...
";
    ...
    match Parser::read_indented_block(&lines, 2, true, None, Some(2), None, false) {
        Ok((lines, _indent, line_diff, _empty_finish)) => {
            eprintln!("{:#?}", lines);
