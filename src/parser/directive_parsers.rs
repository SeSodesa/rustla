...
impl Parser {
    ...
    pub fn parse_standard_admonition(
        ...
        let mut lines = if let Some(arg) = Parser::scan_directive_arguments(
            src_lines,
            line_cursor,
            Some(first_indent),
            empty_after_marker,
    ...
    pub fn parse_class(
        ...
        let classes = if let Some(classes) = Parser::scan_directive_arguments(
            src_lines,
            line_cursor,
            Some(first_indent),
            empty_after_marker,
    ...
    pub fn parse_sphinx_code_block(
        ...
        let formal_language = if let Some(arg) = Parser::scan_directive_arguments(
            src_lines,
            line_cursor,
            first_indent,
            empty_after_marker,
        ...
        let (linenos, lineno_start, emphasize_lines, caption, name, dedent, force) =
            if let Some(mut settings) =
                Parser::scan_directive_options(src_lines, line_cursor, body_indent)
            {
    ...
    pub fn parse_aplus_freetext(
        ...
        let (points, method_string) = if let Some(arg) = Parser::scan_directive_arguments(
            src_lines,
            line_cursor,
            Some(first_indent),
            empty_after_marker,
    ...
    pub fn parse_unknown_directive(
        ...
        let argument = if let Some(arg) = Parser::scan_directive_arguments(
            src_lines,
            line_cursor,
