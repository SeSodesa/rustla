...
lazy_static! {
  ...
  pub static ref ARABIC_PARENS_AUTOMATON: regex::Regex = if let Ok(automaton) = Regex::new(regex_patterns::ARABIC_PARENS_PATTERN) {
    automaton
  } else {
  ...
  /// A DFA for recognising arabic numerals.
  pub static ref ARABIC_RPAREN_AUTOMATON: regex::Regex = if let Ok(automaton) = Regex::new(regex_patterns::ARABIC_RPAREN_PATTERN) {
    automaton
  } else {
  ...
  /// A DFA for recognising arabic numerals.
  pub static ref ARABIC_PERIOD_AUTOMATON: regex::Regex = if let Ok(automaton) = Regex::new(regex_patterns::ARABIC_PERIOD_PATTERN) {
    automaton
  } else {
  ...
  pub static ref LOWER_ALPHA_PARENS_AUTOMATON: regex::Regex = if let Ok(automaton) = Regex::new(regex_patterns::LOWER_ALPHA_PARENS_PATTERN) {
    automaton
  } else {
  ...
  /// A DFA for recognising lower alphabetic numerals.
  pub static ref LOWER_ALPHA_RPAREN_AUTOMATON: regex::Regex = if let Ok(automaton) = Regex::new(regex_patterns::LOWER_ALPHA_RPAREN_PATTERN) {
    automaton
  } else {
  ...
  /// A DFA for recognising lower alphabetic numerals.
  pub static ref LOWER_ALPHA_PERIOD_AUTOMATON: regex::Regex = if let Ok(automaton) = Regex::new(regex_patterns::LOWER_ALPHA_PERIOD_PATTERN) {
    automaton
  } else {
  ...
  pub static ref UPPER_ALPHA_PARENS_AUTOMATON: regex::Regex = if let Ok(automaton) = Regex::new(regex_patterns::UPPER_ALPHA_PARENS_PATTERN) {
    automaton
  } else {
  ...
  /// A DFA for recognising upper alphabetic numerals.
  pub static ref UPPER_ALPHA_RPAREN_AUTOMATON: regex::Regex = if let Ok(automaton) = Regex::new(regex_patterns::UPPER_ALPHA_RPAREN_PATTERN) {
    automaton
  } else {
  ...
  /// A DFA for recognising upper alphabetic numerals.
  pub static ref UPPER_ALPHA_PERIOD_AUTOMATON: regex::Regex = if let Ok(automaton) = Regex::new(regex_patterns::UPPER_ALPHA_PERIOD_PATTERN) {
    automaton
  } else {
  ...
  pub static ref LOWER_ROMAN_PARENS_AUTOMATON: regex::Regex = if let Ok(automaton) = Regex::new(regex_patterns::LOWER_ROMAN_PARENS_PATTERN) {
    automaton
  } else {
  ...
  /// A DFA for recognising lower roman numerals.
  pub static ref LOWER_ROMAN_RPAREN_AUTOMATON: regex::Regex = if let Ok(automaton) = Regex::new(regex_patterns::LOWER_ROMAN_RPAREN_PATTERN) {
    automaton
  } else {
  ...
  /// A DFA for recognising lower roman numerals.
  pub static ref LOWER_ROMAN_PERIOD_AUTOMATON: regex::Regex = if let Ok(automaton) = Regex::new(regex_patterns::LOWER_ROMAN_PERIOD_PATTERN) {
    automaton
  } else {
  ...
  pub static ref UPPER_ROMAN_PARENS_AUTOMATON: regex::Regex = if let Ok(automaton) = Regex::new(regex_patterns::UPPER_ROMAN_PARENS_PATTERN) {
    automaton
  } else {
  ...
  /// A DFA for recognising upper roman numerals.
  pub static ref UPPER_ROMAN_RPAREN_AUTOMATON: regex::Regex = if let Ok(automaton) = Regex::new(regex_patterns::UPPER_ROMAN_RPAREN_PATTERN) {
    automaton
  } else {
  ...
  /// A DFA for recognising upper Roman numerals.
  pub static ref UPPER_ROMAN_PERIOD_AUTOMATON: regex::Regex = if let Ok(automaton) = Regex::new(regex_patterns::UPPER_ROMAN_PERIOD_PATTERN) {
    automaton
  } else {
