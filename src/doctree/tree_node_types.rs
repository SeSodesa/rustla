...
pub enum TreeNodeType {
    ...
    Caption { indent: usize },

    /// A generic citation target.
    Citation { body_indent: usize, label: String },
    ...
    DefinitionList { term_indent: usize },
    ...
    ///
    /// Details: https://docutils.sourceforge.io/docs/ref/rst/directives.html#document-header-footer
    Header { body_indent: usize },

    /// An image without a surrounding figure node. Can be inserted inline, as well
    ...
    OptionList { option_indent: usize },
    ...
    ///         +----------------------------------+
    /// ```
    OptionListItem { body_indent: usize },
    ...
    AplusPickChoices { body_indent: usize },
    ...
    AplusQuestionnaireHints { body_indent: usize },
...
impl std::fmt::Display for TreeNodeType {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let node_type_str: &str = match self {
            ...
            Self::AutomaticSectionNumbering { .. } => {
                todo!("auto section numbering is not really a node?")
            }
            Self::BlockQuote { .. } => "block quote",
            Self::BulletList { .. } => "bullet list",
            Self::BulletListItem { .. } => "bullet list item",
            ...
            Self::CompoundParagraph { .. } => "compound paragraph",
            ...
            Self::DefinitionListItem { .. } => "definition list item",
            Self::Description => "description",
            Self::DocInfo => "docinfo",
            Self::DoctestBlock { .. } => "doc test block",
            Self::Document { .. } => "document",
            Self::Emphasis { .. } => "emphasis",
            Self::EmptyLine => "emptyline",
            Self::Entry { .. } => "entry",
            Self::EnumeratedList { .. } => "enumerated list",
            Self::EnumeratedListItem { .. } => "enumerated list item",
            Self::ExternalHyperlinkTarget { .. } => "external hyperlink target",
            Self::Field => "field",
            Self::FieldBody { .. } => "field body",
            Self::FieldList { .. } => "field list",
            Self::FieldListItem { .. } => "field list item",
            Self::Figure { .. } => "figure",
            Self::Footer { .. } => "footer",
            ...
            Self::InterpretedText { .. } => "interpreted text",
            Self::Label { .. } => "label",
            Self::Legend { .. } => "legend",
            Self::Line { .. } => "line",
            ...
            Self::LiteralBlock { .. } => "literal block",
            Self::Math { .. } => "math",
            Self::MathBlock { .. } => "math block",
            Self::OptionList { .. } => "option list",
            Self::OptionListItem { .. } => "option list item",
            Self::OptionString { .. } => "option string",
            Self::Organization { .. } => "organization",
            Self::Paragraph { .. } => "paragraph",
            Self::ParsedLiteralBlock { .. } => "parsed literal block",
            ...
            Self::SubstitutionReference { .. } => "substitution reference",
            Self::Subtitle { .. } => "subtitle",
            Self::Superscript { .. } => "superscript",
            Self::SystemMessage { .. } => "system message",
            Self::Table { .. } => "table",
            Self::Target { .. } => "target",
            Self::TBody { .. } => "table body",
            Self::Term { .. } => "term",
            Self::Text { .. } => "text",
            Self::TGroup { .. } => "table group",
            Self::THead { .. } => "table head",
            Self::TRow { .. } => "table row",
            Self::Title { .. } => "title",
            ...
            //  A+ specific directives
            // ========================
            Self::AplusPOI { .. } => "aplus point of interest",
            Self::AplusColBreak => "aplus column break",
            Self::AplusQuestionnaire { .. } => "aplus questionnaire",
            Self::AplusPickOne { .. } => "aplus pick one",
            Self::AplusPickAny { .. } => "aplus pick any",
            Self::AplusFreeText { .. } => "aplus freetext",
            Self::AplusPickChoices { body_indent, .. } => "aplus pick choices",
            Self::AplusPickChoice { .. } => "aplus pick choice",
            Self::AplusQuestionnaireHints { .. } => "aplus questionnaire hints",
            Self::AplusQuestionnaireHint { .. } => "aplus questionnaire hint",
            Self::AplusSubmit { .. } => "aplus submit",
            Self::AplusActiveElementInput { .. } => "aplus active element input",
            Self::AplusActiveElementOutput { .. } => "aplus active element output",
        };
